...
public class AddViewResponse  implements java.io.Serializable {
    private com.microsoft.schemas.sharepoint.soap.AddViewResponseAddViewResult addViewResult;

    public AddViewResponse() {
    }

    public AddViewResponse(
           com.microsoft.schemas.sharepoint.soap.AddViewResponseAddViewResult addViewResult) {
     ...
     */
    public com.microsoft.schemas.sharepoint.soap.AddViewResponseAddViewResult getAddViewResult() {
        return addViewResult;
    }
     ...
     * @param addViewResult
     */
    public void setAddViewResult(com.microsoft.schemas.sharepoint.soap.AddViewResponseAddViewResult addViewResult) {
        this.addViewResult = addViewResult;
    }
