...
public class DocumentType implements java.io.Serializable {
    ...
    public static final DocumentType system = new DocumentType(_system);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.microsoft.com/sharepoint/dsp", "DocumentType"));
    }
    /**
