...
public class AlertsLocator extends org.apache.axis.client.Service implements com.microsoft.schemas.sharepoint.soap._2002._1.alerts.Alerts {
    ...
    private java.lang.String AlertsSoap_address = "http://freesharepointhosting.net/_vti_bin/alerts.asmx";
    ...
    public com.microsoft.schemas.sharepoint.soap._2002._1.alerts.AlertsSoap getAlertsSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.microsoft.schemas.sharepoint.soap._2002._1.alerts.AlertsSoap getAlertsSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.microsoft.schemas.sharepoint.soap._2002._1.alerts.AlertsSoapStub _stub = new com.microsoft.schemas.sharepoint.soap._2002._1.alerts.AlertsSoapStub(portAddress, this);
    ...
    private java.lang.String AlertsSoap12_address = "http://freesharepointhosting.net/_vti_bin/alerts.asmx";
    ...
    public com.microsoft.schemas.sharepoint.soap._2002._1.alerts.AlertsSoap getAlertsSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.microsoft.schemas.sharepoint.soap._2002._1.alerts.AlertsSoap getAlertsSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.microsoft.schemas.sharepoint.soap._2002._1.alerts.AlertsSoap12Stub _stub = new com.microsoft.schemas.sharepoint.soap._2002._1.alerts.AlertsSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.microsoft.schemas.sharepoint.soap._2002._1.alerts.AlertsSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.microsoft.schemas.sharepoint.soap._2002._1.alerts.AlertsSoapStub _stub = new com.microsoft.schemas.sharepoint.soap._2002._1.alerts.AlertsSoapStub(new java.net.URL(AlertsSoap_address), this);
                _stub.setPortName(getAlertsSoapWSDDServiceName());
                return _stub;
            }
            if (com.microsoft.schemas.sharepoint.soap._2002._1.alerts.AlertsSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.microsoft.schemas.sharepoint.soap._2002._1.alerts.AlertsSoap12Stub _stub = new com.microsoft.schemas.sharepoint.soap._2002._1.alerts.AlertsSoap12Stub(new java.net.URL(AlertsSoap12_address), this);
                _stub.setPortName(getAlertsSoap12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        if ("AlertsSoap".equals(inputPortName)) {
            return getAlertsSoap();
        }
        else if ("AlertsSoap12".equals(inputPortName)) {
