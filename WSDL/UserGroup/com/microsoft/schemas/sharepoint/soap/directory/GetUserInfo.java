...
public class GetUserInfo  implements java.io.Serializable {
    ...
    /**
     * Gets the userLoginName value for this GetUserInfo.
     * 
    ...
    /**
     * Sets the userLoginName value for this GetUserInfo.
     * 
     * @param userLoginName
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.microsoft.com/sharepoint/soap/directory/", ">GetUserInfo"));
